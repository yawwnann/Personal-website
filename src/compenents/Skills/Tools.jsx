...
const Marquee = () => {
  ...
  return (
    <div className="overflow-hidden bg-neutral-900 rotate-4 mt-8 ">
      {/* ini ke kiri */}
      <div className="marquee-container-skills-left  z-10 flex gap-8 whitespace-nowrap text-white">
        ...
        <div className="flex items-center py-3 px-2 space-x-2 font-poppins text-lg hover:bg-zinc-900 hover-effect">
